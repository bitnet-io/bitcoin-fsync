...
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitcoin Core fsync"
...
#define PACKAGE_NAME "Bitcoin Core fsync"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcoin Core fsync 27.99.0"
...
#define PACKAGE_VERSION "27.99.0 fsync"
